          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="mt-1 appearance-none relative block w-full px-3 py-2 border border-primary-300 placeholder-gray-500 text-primary-900 rounded-md focus:outline-none focus:ring-primary-500 focus:border-primary-500"
